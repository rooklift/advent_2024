...
def solve_code(big_kp_dict, small_kp_dict, code, intermediate_robots):
	...
	for n in range(intermediate_robots - 1):
...
# Given that we start at A, what movements of our own arm (including pushes)
# do we need to make to get the robot above us to push c, given that it too
# starts at position A?
#
# Eh, this isn't right I think.
...
def main():
	...
	result = 0
	for code in ["029A"]:	# codes:
		result += solve_code(big_kp_dict, small_kp_dict, code, 2)
	print(result)			# expect 1972 for example 029A
